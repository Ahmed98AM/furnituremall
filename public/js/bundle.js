...
var showAlert = function showAlert(type, msg) {
  ...
  window.setTimeout(hideAlert, 50000);
};

exports.showAlert = showAlert;
},{}],"addItems.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.addProduct = exports.addBillProducts = exports.addBill = void 0;
...
var addProduct = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(name, image, priceA, priceB, priceC, number) {
    var res;
  ...
  return function addProduct(_x, _x2, _x3, _x4, _x5, _x6) {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Bill added');
              location.assign("/bills/new/".concat(res.data.data._id));
            }
...
var addBillProducts = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Bill product added');
  ...
  return function addBillProducts(_x7) {
    return _ref3.apply(this, arguments);
  };
}();

exports.addBillProducts = addBillProducts;
},{"./alerts":"alerts.js"}],"updateItems.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateProduct = exports.updateBill = void 0;
...
var updateProduct = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(url, name, image, priceA, priceB, priceC, number) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
  ...
  return function updateProduct(_x, _x2, _x3, _x4, _x5, _x6, _x7) {
    return _ref.apply(this, arguments);
  };
}();
...
var updateBill = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(url, dataObj) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Bill updated');
              location.assign("/bills");
            }
  ...
  return function updateBill(_x8, _x9) {
    return _ref2.apply(this, arguments);
  };
}();

exports.updateBill = updateBill;
},{"./alerts":"alerts.js"}],"deleteItems.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.deleteProduct = exports.deleteBillProduct = exports.deleteBill = void 0;
...
var deleteBill = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Bill deleted');
              location.assign("/bills");
            }
  ...
  return function deleteBill(_x2) {
    return _ref2.apply(this, arguments);
  };
}();
...
var deleteBillProduct = /*#__PURE__*/function () {
  ...
  return function deleteBillProduct(_x3) {
    return _ref3.apply(this, arguments);
  };
}();

exports.deleteBillProduct = deleteBillProduct;
...
var _addItems = require("./addItems");
...
var navBar = document.querySelector('#navy');
var bodyClassName = document.querySelector('body').className;
var bodyClassNameArray = bodyClassName.split(' ');
var billContainerDiv = document.querySelector('.billContainer');
var addProductForm = document.querySelector('.addProductForm');
var addBillForm = document.querySelector('.addBillForm');
var addBillButton = document.querySelector('.addBillButton');
var addBillProductsButton = document.querySelector('.addBillProductsButton');
var updateProductForm = document.querySelector('.updateProductForm');
var updateBillForm = document.querySelector('.updateBillForm');
var delProductForms = document.querySelectorAll('.delProductForm');
var delBillForms = document.querySelectorAll('.delBillForm');
var delBillProductButtons = document.querySelectorAll('.delBillProductButton');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            return _context.abrupt("return", foundProducts);
...
var deleteBillProductListner = function deleteBillProductListner(delBillProductButtons) {
  delBillProductButtons.forEach(function (delBillProductButton) {
    delBillProductButton.addEventListener('click', function (e) {
      ...
      if (this.getAttribute('delBillProductURL')) {
        (0, _deleteItems.deleteBillProduct)(this.getAttribute('delBillProductURL'));
      }
...
var billProductHTML = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
    var billId, foundProducts, prodNamesListHtml, html;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            billId = addBillForm ? window.location.pathname.split('/').slice(-1) : window.location.pathname.split('/').slice(-2)[0];
            _context2.next = 3;
            return getProducts();
          ...
          case 3:
            ...
            prodNamesListHtml = function prodNamesListHtml() {
              var tempHTMLHolder = '';
              ...
              if (foundProducts.data) {
                foundProducts.data.foundProducts.forEach(function (foundProduct) {
                  ...
                  tempHTMLHolder = tempHTMLHolder + "<option value=\"".concat(foundProduct.name, "\">\n              ").concat(foundProduct.name, "\n            </option>");
                });
  ...
  return function billProductHTML() {
    return _ref2.apply(this, arguments);
  };
...
if (addBillForm || updateBillForm) {
  var updateDeleteBillProductButtonsCounter = 0;
  ...
  addBillProductsButton.addEventListener('click', /*#__PURE__*/function () {
      ...
      return regeneratorRuntime.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              e.preventDefault();
              _context3.t0 = billContainerDiv;
              _context3.next = 4;
              return billProductHTML();
            ...
            case 4:
              ...
              deleteBillProductListner(Array.prototype.slice.call(delBillProductButtons).slice(updateDeleteBillProductButtonsCounter));
...
if (addBillButton) addBillButton.addEventListener('click', function (e) {
  e.preventDefault();
  (0, _addItems.addBill)();
});
if (addProductForm) addProductForm.addEventListener('submit', function (e) {
  ...
  var prodPriceA = document.querySelector('.prodPriceA');
  var prodPriceB = document.querySelector('.prodPriceB');
  var prodPriceC = document.querySelector('.prodPriceC');
  var prodNumber = document.querySelector('.prodNumber');
  (0, _addItems.addProduct)(prodName.value, prodImg.value, prodPriceA.value, prodPriceB.value, prodPriceC.value, prodNumber.value);
});
...
if (addBillForm) {
  addBillForm.addEventListener('submit', function (e) {
    ...
    var billIds = document.querySelectorAll('.billId');
    ...
    var dataObj = _objectSpread({}, dataArr);

    if (dataNamesArr.length === new Set(dataNamesArr).size) (0, _addItems.addBillProducts)(dataObj);else (0, _alerts.showAlert)('error', 'There is a field with duplicated name please enter a new name or delete the field');
  });
} // updating items


if (updateProductForm) updateProductForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var prodName = document.querySelector('.prodName');
  var prodImg = document.querySelector('.prodImg');
  var prodPriceA = document.querySelector('.prodPriceA');
  ...
  var prodPriceC = document.querySelector('.prodPriceC');
  var prodNumber = document.querySelector('.prodNumber');
  (0, _updateItems.updateProduct)(this.getAttribute('action'), prodName.value, prodImg.value, prodPriceA.value, prodPriceB.value, prodPriceC.value, prodNumber.value);
});
if (updateBillForm) updateBillForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var dataArr = [];
  var dataNamesArr = [];
  var prices = document.querySelectorAll('.price');
  ...
  var numbers = document.querySelectorAll('.number');
  var billIds = document.querySelectorAll('.billId');
  var billProductIds = document.querySelectorAll('.billProductId');
  if (billProductIds) for (var i = 0; i < billProductIds.length; i++) {
    dataNamesArr.push(names[i].value);
    dataArr.push({
      price: prices[i].value,
      name: names[i].value,
